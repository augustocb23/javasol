...
public class GameState {
    ...
    public GameState(GameInfo gameInfo, ClassicDeck deck, Stack revealedCards, SolitaireStack[] solStack,
                     SequentialStack[] seqStack) {
        super();
                ...
                if (dst != null && dst.isValid(curr)) {
                    ...
                    if (src.isEmpty() | (!src.isEmpty() && src.top().isFaceDown())) {
                        ...
                        if (!(src.isEmpty() && dst.isEmpty())) {
                            ...
                            if (verbose) {
                                System.out.println("Legal Move " + cOut.getValue() + cOut.getSuit() + " To Sol Stack "
                                        + (j2 + 1));
    ...
    public void restoreGameState(GameInfo gameInfo, ClassicDeck deck, Stack revealedCards, SolitaireStack[] solStack,
                                 SequentialStack[] seqStack, Move move) {
